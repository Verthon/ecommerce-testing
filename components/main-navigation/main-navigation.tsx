...
import { useToggle } from "app/shared/hooks/useToggle/useToggle";
  ...
  if (status === "authenticated")
    return (
      <button
        ...
        className="mr-2 rounded-lg border border-transparent bg-transparent px-5 py-1.5 text-sm font-medium text-gray-100 hover:text-white focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-200"
      >
...
const navigation = {
  ...
  pages: [{ name: "home.navbar.company", href: "/about" }],
} as const;
              ...
              <div className="border-b border-gray-200">
                <div className="flex h-16 items-center justify-between">
                  <div className="hidden lg:flex lg:flex-1 lg:items-center">
                    <Link href="/">
                      <span className="sr-only">Brand Eyewear</span>
                      <img
                  ...
                  <div className="flex flex-1 items-center justify-end">
                    <div className="flex items-center lg:ml-8">
                      <Link
                        href="/contact"
                        className="p-2 capitalize text-gray-400 hover:text-gray-500 lg:hidden"
                      >
                        <span className="sr-only">
                      ...
                      <Link
                        href="/contact"
                        className="hidden text-sm font-medium capitalize text-gray-700 hover:text-gray-800 lg:block"
                      >
                        {t("home.navbar.contact")}
                      </Link>
